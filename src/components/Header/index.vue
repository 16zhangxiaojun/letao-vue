<template>
    <header id="header">
        <slot></slot> <h1>{{ title }}</h1><span>{{$store.state.city.city_weath}}</span>
    </header>
</template>
...
#header span{position: absolute;top: 0;left: 10px; font-size: 18px; text-align: center; line-height: 50px; font-weight: normal; }
